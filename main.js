...
function sorting()
{
    ...
    var display_friend_array_sorting = [];
    ...
    for (var k = 0; k < longitud_nombre_alumnos_array; k++)
    {
        display_friend_array_sorting.push("<h4>NOMBRE - " + nombre_alumno_array[k] + "</h4>");
        console.log(display_friend_array_sorting);
    }


    var remover_comas = display_friend_array_sorting.join(" ");
    console.log(remover_comas);
